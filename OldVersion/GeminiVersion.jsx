...
const animals = [
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+a+wolf+head+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+an+elephant+walking+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+an+octopus+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+a+raven+flying+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+a+beaver+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+a+dolphin+jumping+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+a+capybara+sitting+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+an+owl+perched+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+an+ant+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
            ...
            },
            {
                ...
                image: '/gen?prompt=minimalist+constellation+diagram+of+a+tiger+walking+on+a+dark+blue+background+with+glowing+star+nodes+and+fine+gold+lines+scientific+astronomy+style&aspect=1:1',
        ...
        const Slider = ({ trait, value, onChange, desc }) => (
            <div className="trait-group group mb-12">
                <div className="flex justify-between mb-4 items-end">
                    ...
                    <span className="text-2xl font-serif text-indigo-300 w-12 text-right">{value}</span>
                </div>
                <input 
                    type="range" 
                    min="0" 
            ...
            return (
                <div className="relative min-h-screen">
                    ...
                    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
                        <div className="absolute top-0 left-1/4 w-96 h-96 bg-indigo-900/20 rounded-full blur-3xl animate-pulse" style={{animationDuration: '8s'}}></div>
                        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-slate-800/20 rounded-full blur-3xl animate-pulse" style={{animationDuration: '10s', animationDelay: '1s'}}></div>
                    </div>
                    ...
                    <nav className="relative z-10 w-full px-6 py-6 flex justify-between items-center max-w-7xl mx-auto border-b border-white/5">
                        <div className="flex items-center gap-2 cursor-pointer" onClick={() => setView('intro')}>
                            ...
                            <span className="serif text-xl tracking-wider text-slate-200">ARCHETYPE MAP</span>
                        </div>
                        <div className="flex gap-6 items-center">
                            <button className="text-sm text-slate-400 hover:text-white transition-colors flex items-center gap-1" onClick={downloadSource}>
                                <Icon name="download" className="text-[18px]" />
                                <span className="hidden sm:inline">Export JSX</span>
                            </button>
                            <button className="text-sm text-slate-400 hover:text-white transition-colors" onClick={() => setIsAboutOpen(true)}>
                                The Science
                            </button>
                        </div>
                    </nav>
                        ...
                        {view === 'intro' && (
                            <div className="text-center max-w-2xl animate-fade-in">
                                ...
                                <p className="text-lg text-slate-400 mb-12 font-light leading-relaxed">
                                    Beyond simple labels. This system translates your Big Five personality traits into a weighted constellation of ecological strategies. 
                                    Are you a pack-oriented coordinator, a solitary specialist, or an adaptable generalist?
                                </p>
                                <button 
                        ...
                        {view === 'processing' && (
                            <div className="flex flex-col items-center justify-center h-64 w-full">
                                <div className="relative w-24 h-24">
                                    ...
                                    <div className="absolute inset-2 border-r-2 border-slate-600 rounded-full animate-spin" style={{animationDirection: 'reverse', animationDuration: '1.5s'}}></div>
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <Icon name="hub" className="text-indigo-300 text-3xl" />
                                    </div>
                                </div>
                                <p className="mt-8 text-slate-400 font-serif text-xl animate-pulse">Mapping ecological strategies...</p>
                            </div>
                        )}
                        ...
                        {view === 'results' && results.length > 0 && (
                            <div className="w-full animate-slide-up pb-20">
                                <div className="text-center mb-12">
                                    <span className="text-indigo-400 text-sm tracking-[0.2em] uppercase mb-2 block">Your Archetype Map</span>
                                ...
                                <div className="glass-panel p-1 rounded-2xl mb-8 relative overflow-hidden group">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-0">
                                        <div className="bg-slate-900/50 relative min-h-[400px]">
                                            <img src={results[0].image} alt={results[0].name} className="absolute inset-0 w-full h-full object-cover opacity-90 mix-blend-screen" />
                                        ...
                                        <div className="p-8 md:p-12 flex flex-col justify-center">
                                            <h3 className="serif text-5xl text-white mb-2">{results[0].name}</h3>
                                            <p className="text-indigo-300 italic text-lg mb-6 font-serif">{results[0].tagline}</p>
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {results[0].keywords.map(k => (
                                                        <span key={k} className="px-3 py-1 bg-indigo-900/40 border border-indigo-500/30 rounded text-xs text-indigo-200">
                                                            {k}
                                                        </span>
                                                    ))}
                                                </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mb-12">
                                    {[1, 2].map((idx) => {
                                        ...
                                        return (
                                            <div key={animal.id} className="glass-panel rounded-xl overflow-hidden p-6 flex flex-col hover:bg-slate-800/50 transition-colors animal-card-hover cursor-pointer group">
                                                <div className="flex items-center gap-4 mb-4">
                                                    <img src={animal.image} className="w-16 h-16 rounded-full object-cover border border-slate-600 bg-slate-900 group-hover:border-indigo-400 transition-colors" />
                                                    <div>
                                                        <div className="text-xs text-indigo-400 uppercase tracking-wider mb-1">
                                                            {idx === 1 ? 'Secondary Influence' : 'Tertiary Influence'}
                                                        </div>
                    ...
                    {isAboutOpen && (
                        <div className="fixed inset-0 z-50 bg-slate-900/90 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
                            <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative">
                                <button className="absolute top-4 right-4 text-slate-400 hover:text-white" onClick={() => setIsAboutOpen(false)}>
                                    <Icon name="close" />
                                </button>
                                <div className="p-8">
                                    <h2 className="serif text-3xl text-white mb-2">The Science Behind the Map</h2>
                                    <p className="text-indigo-400 text-sm mb-6 uppercase tracking-wider">Ecological Strategy vs. Personality</p>
                                    <div className="space-y-6 text-slate-300 leading-relaxed">
                                        <p>
                                            This system uses the <strong className="text-white">Big Five</strong> personality model—the gold standard in modern psychology—and maps it to biological "ecological strategies." 
                                        </p>
                                        <p>
                                            In nature, traits are not "good" or "bad"; they are trade-offs. 
                                            A <em className="italic">Wolf's</em> high agreeableness is a survival mechanism for pack cohesion. 
                                            An <em className="italic">Octopus's</em> low extraversion is a necessity for a solitary ambush predator.
                                        </p>
